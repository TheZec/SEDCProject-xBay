...
import sptest.zec.com.xbay.Activities.Profile;

/**
 * Created by Aleksandar on 10/26/2014.
 */
public class SharedPrefUser {
    ...
    public void checkLogin() {
        ...
        if (!this.isLoggedIn()) {
            ...
            Intent i = new Intent(_context, MyXBay.class);
            ...
            Intent myXbay = new Intent(_context, Profile.class);
            _context.startActivity(myXbay);
        }
